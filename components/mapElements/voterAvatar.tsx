...
import { getUserActivityLabel, getUserInitialsLabel, getUserSeedLabel } from "../../lib/userDisplay";
...
export default function renderVoterAvatar(
  ...
  el.style.backgroundColor = getTone(getUserSeedLabel(user));
  el.textContent = getUserInitialsLabel(user);
  ...
  label.textContent = getUserActivityLabel(user);
